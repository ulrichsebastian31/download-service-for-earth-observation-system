 ...
 */
package net.eads.astrium.ips.dseo.ds.wps.workers;
...
import net.eads.astrium.ips.wps.ProcessesLoader;
import net.eads.astrium.ips.wps.WPSProcessMap;
import net.eads.astrium.ips.wps.processes.FileInputsDatabaseWPSProcess;
import net.eads.astrium.ips.wps.processes.SimpleInputsDatabaseWPSProcess;
import net.eads.astrium.ips.wps.workers.GenericWPSWorker;
...
public class DSWorker extends GenericWPSWorker {
            ...
            throws Exception
    {
        ...
        WPSProcessMap procClasses = ProcessesLoader.getProcesses("net.eads.astrium.ips.dseo.ds.wps.processes");
